...
/*
 * This function will check the list at the head to see if it's empty. If it is,
 * then the function will return 1, but if it's not empty then it will return 0.
 *  
 * Params:
 *    list - The linked list to be checked if it's empty.
 */
...
/*
 * This function will add the values to the front of the list in the head.
 *  
 * Params:
...
/*
 * This function will remove AKA "pop" the elements added to the head, as 
 * stacks have a first in last out order of removal.
 *  
 * Params:
 *    list - The linked list to be removed from.
 */
void* list_pop(struct list* list) {
  struct link* val = list->head;
